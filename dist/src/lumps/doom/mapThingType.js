...
var WADMapThingClass;
(function (WADMapThingClass) {
    // Monsters/enemies
    WADMapThingClass[WADMapThingClass["Monster"] = 0] = "Monster";
    // Weapon item pickups
    WADMapThingClass[WADMapThingClass["Weapon"] = 1] = "Weapon";
    // Ammunition item pickups
    WADMapThingClass[WADMapThingClass["Ammo"] = 2] = "Ammo";
    // Item pickups that DO count against the intermission screen percentage
    WADMapThingClass[WADMapThingClass["Artifact"] = 3] = "Artifact";
    // Item pickups that do NOT count against the intermission screen percentage
    WADMapThingClass[WADMapThingClass["Powerup"] = 4] = "Powerup";
    // Key pickup; allows opening of some locked doors
    WADMapThingClass[WADMapThingClass["Key"] = 5] = "Key";
    // Decorative things (collides with monsters and players)
    WADMapThingClass[WADMapThingClass["Obstacle"] = 6] = "Obstacle";
    // Decorative things (no collision)
    WADMapThingClass[WADMapThingClass["Decoration"] = 7] = "Decoration";
    // Romero head thing
    WADMapThingClass[WADMapThingClass["Romero"] = 8] = "Romero";
    // Player and deathmath starts
    WADMapThingClass[WADMapThingClass["PlayerStart"] = 9] = "PlayerStart";
    // Monster spawner and destination things
    WADMapThingClass[WADMapThingClass["Spawner"] = 10] = "Spawner";
    // Teleport destination
    WADMapThingClass[WADMapThingClass["Teleport"] = 11] = "Teleport";
})(WADMapThingClass = exports.WADMapThingClass || (exports.WADMapThingClass = {}));
// A list of known thing types.
// TODO: Needs more detail.
// TODO: Account for e.g. DeHackEd patches.
exports.WADMapThingTypeList = [
    // Artifact items
...
exports.WADMapThingTypeMap = (() => {
    const map = {};
    for (const thingType of exports.WADMapThingTypeList) {
        map[thingType.id] = thingType;
    }
    return map;
})();
//# sourceMappingURL=mapThingType.js.map